...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('USER', 'FARMER', 'VENDOR', 'ADMIN', name='userrole'), nullable=False),
    ...
    op.create_index(op.f('ix_farmer_products_id'), 'farmer_products', ['id'], unique=False)
    op.create_index(op.f('ix_farmer_products_name'), 'farmer_products', ['name'], unique=False)
    ...
    sa.Column('vendor_id', sa.Integer(), nullable=False),
    sa.Column('crop_name', sa.String(length=150), nullable=False),
    sa.Column('crop_variety', sa.String(length=150), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('price_per_unit', sa.Float(), nullable=False),
    sa.Column('unit', sa.Enum('KG', 'QUINTAL', 'TON', name='bulkunit'), nullable=True),
    ...
    op.create_index(op.f('ix_vendor_products_crop_name'), 'vendor_products', ['crop_name'], unique=False)
    ...
    sa.ForeignKeyConstraint(['product_id'], ['farmer_products.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['product_id'], ['farmer_products.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('total_amount', sa.Float(), nullable=False),
    sa.Column('buyer_id', sa.Integer(), nullable=True),
    sa.Column('buyer_type', sa.Enum('FARMER', 'USER', name='buyertype'), nullable=False),
    sa.Column('delivery_address', sa.Text(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_vendor_products_crop_name'), table_name='vendor_products')
    ...
    op.drop_index(op.f('ix_farmer_products_name'), table_name='farmer_products')
    op.drop_index(op.f('ix_farmer_products_id'), table_name='farmer_products')
